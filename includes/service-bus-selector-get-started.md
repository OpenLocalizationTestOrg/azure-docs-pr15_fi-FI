> [AZURE. VALITSIN-luettelo (lähettäjän | Vastaanottajan)]
...
- [(C# | Apache myrsky)](../articles/event-hubs/event-hubs-csharp-storm-getstarted.md)
...
- [(Java | Apache myrsky)](../articles/event-hubs/event-hubs-java-storm-getstarted.md)
- [(C | C#)](../articles/event-hubs/event-hubs-c-ephcs-getstarted.md)
- [(C | Java)](../articles/event-hubs/event-hubs-c-ephjava-getstarted.md)
- [(C | Apache myrsky)](../articles/event-hubs/event-hubs-c-storm-getstarted.md)