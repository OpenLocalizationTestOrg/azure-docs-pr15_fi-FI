<properties
   pageTitle="SQL-tietovarasto järjestelmänäkymiä | Microsoft Azure"
   description="Järjestelmän linkkejä näkee sisällön SQL-tietovarasto varten."
...
# <a name="system-views"></a>Järjestelmänäkymiä

## <a name="sql-data-warehouse-catalog-views"></a>SQL-tietovarasto luettelon näkymät
...
## <a name="sql-data-warehouse-dynamic-management-views-dmvs"></a>SQL-tietovarasto dynaaminen hallinta näkymät (DMVs)
...
## <a name="sql-server-dmvs-applicable-to-sql-data-warehouse"></a>SQL Server DMVs koskevat SQL-tietovarasto

Seuraavat DMVs sovelletaan SQL-tietovarasto, mutta se on suoritettava yhdistämällä **master** -tietokantaan.

- [sys.database_service_objectives](https://msdn.microsoft.com/library/mt712619.aspx)
- [sys.dm_operation_status](https://msdn.microsoft.com/library/dn270022.aspx)
- [sys.fn_helpcollations()](https://msdn.microsoft.com/library/ms187963.aspx)

## <a name="sql-server-catalog-views"></a>SQL Server-luettelon näkymät
...
## <a name="sql-server-dmvs-available-in-sql-data-warehouse"></a>SQL Server DMVs käytettävissä SQL varastossa

SQL-tietovarasto paljastaa useita SQL Serverin dynaaminen hallinta näkymiä (DMVs). Nämä näkymät kysely SQL-tietovarasto tehdä ilmoituksen SQL-tietokantoja jaot käytössä tila.

Koska SQL-tietovarasto muodostanut Microsoftin MPP-tekniikan, SQL-tietovarasto ja Analytics Platform järjestelmän rinnakkain tietojen varasto (PDW) Käytä samaa järjestelmänäkymiä.

Tämän vuoksi nämä DMV on nimeltään pdw_node_id tietyn sarakkeen. Tämä on Laske-solmu tunnus. PDW Laske solmu on vahvempi käsite käyttöympäristön. SQL-tietovarasto-arkkitehtuuri perustuu Lisää raskaasti jaot.

>[AZURE.NOTE] Voit käyttää näitä näkymää, Aseta 'pdw_nodes_' nimen, seuraavassa taulukossa kuvatulla tavalla.


| SQL-tietovarasto DMV nimi | SQL Server Transact-SQL-aiheessa MSDN-linkki |
| :----------------------------- | :-------------------------------------------- |
...
| sys.dm_pdw_nodes_os_dispatchers | Transact-SQL-ohjeista ei ole käytettävissä. |
...
| sys.dm_pdw_nodes_os_memory_node_access_stats | Transact-SQL-ohjeista ei ole käytettävissä. |
...
| sys.dm_pdw_nodes_os_spinlock_stats | Transact-SQL-ohjeista ei ole käytettävissä. |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-sql-data-warehouse"></a>SQL Server 2016 PolyBase DMVs käytettävissä SQL varastossa
...
## <a name="sql-server-informationschema-views"></a>SQL Server INFORMATION_SCHEMA näkymät

- [CHECK_CONSTRAINTS](http://msdn.microsoft.com/library/ms189772.aspx)
- [SARAKKEET](http://msdn.microsoft.com/library/ms188348.aspx)
- [PARAMETRIT](http://msdn.microsoft.com/library/ms173796.aspx)
- [RUTIINIT](https://msdn.microsoft.com/library/ms188757.aspx)
- [SCHEMATA](https://msdn.microsoft.com/library/ms182642.aspx)
- [TAULUKOT](http://msdn.microsoft.com/library/ms186224.aspx)
...
- [NÄKYMÄT](http://msdn.microsoft.com/library/ms181381.aspx)
