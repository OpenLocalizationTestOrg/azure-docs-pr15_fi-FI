<properties
   pageTitle="SharePoint-Connectorin avulla logiikan sovelluksissa | Sovelluksen Microsoft Azure-palvelu"
   description="Voit luoda ja määritä SharePoint yhdistimen tai API-sovellus ja käyttää sitä Azure-sovelluksen palvelun logiikan-sovelluksessa"
   services="logic-apps"
...
# <a name="weve-improved-the-sharepoint-connector"></a>Microsoft on parannettu SharePoint-yhdistin 
...
- [Lue lisätietoja tämän uuden yhdistin](../connectors/connectors-create-api-sharepointserver.md)
