<properties
    pageTitle="Logiikan sovelluksissa SFTP Connectorin avulla | Sovelluksen Microsoft Azure-palvelu"
    description="Voit luoda ja määritä SFTP yhdistimen tai API-sovellus ja käytä Azure-sovelluksen palvelun logiikan-sovelluksessa"
    authors="msftman"
    manager="erikre"
    editor=""
    services="logic-apps"
...
# <a name="weve-improved-the-sftp-connector"></a>Microsoft on parannettu SFTP-yhdistin 
...
- [Lue lisätietoja tämän uuden yhdistin](../connectors/connectors-create-api-sftp.md)
