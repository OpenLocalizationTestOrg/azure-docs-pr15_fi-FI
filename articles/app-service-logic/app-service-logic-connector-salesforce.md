<properties
   pageTitle="Salesforce-Connectorin avulla logiikan sovelluksissa | Sovelluksen Microsoft Azure-palvelu"
   description="Voit luoda ja määritä Salesforce yhdistimen tai API-sovellus ja käyttää sitä Azure-sovelluksen palvelun logiikan-sovelluksessa"
   services="logic-apps"
...
# <a name="weve-improved-the-salesforce-connector"></a>Olemme olet parannetut Salesforce-yhdistin 
...
- [Lue lisätietoja tämän uuden yhdistin](../connectors/connectors-create-api-salesforce.md)
