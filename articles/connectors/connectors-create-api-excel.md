<properties
pageTitle="Lisää Excel-yhdistin | Microsoft Azure"
description="Yleistä REST API parametreilla Excel-yhdistin"
services=""    
documentationCenter=""     
authors="msftman"    
manager="erikre"    
...
# <a name="get-started-with-the-excel-connector"></a>Aloita Excel-yhdistin

Tällä hetkellä ei ole Excel-yhdistin logiikan-sovelluksissa. 

## <a name="to-use-excel-data"></a>Jos haluat käyttää Excelin tietoja
Voit tallentaa Excel-tietojen CSV (CSV)-tiedostona tallennuskansion, kuten [OneDrive](connectors-create-api-onedrive.md). Voit käyttää myös CSV-tiedoston, [tiedostossa yhdistin](../app-service-logic/app-service-logic-enterprise-integration-flatfile.md).
